      ...
      <div class="container">
          ...
          <div class="row">
           <div class="col-md-6">
            ...
            <div class="col-md-3">
              <a style="color:white;" class="btn btn-round btn-primary" data-toggle="modal" data-target="#insertUser">Insertar Usuario</a>
            </div>
          <div class="col-md-12">
            <div class="card">
                  ...
                  @foreach($usuarios as $user)
                    <tr>
                      ...
                      <td class="text-center">
                           <a class="btn btn-round btn-warning btn-icon btn-sm" href="/actualizarUsuario/{{$user->id}}" ><i class="fas fa-edit"></i></a>
                                            ...
                                            <form action="/eliminarUsuario" method="post" >
                                              {{csrf_field()}}
                                                <div class="modal-body">
                                                    ...
                                                    <p style="float:left;">
                                                    Estas seguro que quieres eliminar al usuario {{$user->name}}?<br><br><br><br>
                                                  </p>
                                                  <br><br><br><br>
      ...
      <div class="modal-body">
        ...
        <form method="POST" action="/insertarUsuario">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="idTipoUsuario" style="margin-bottom:20px; margin-top:20px;"  required="">
